...
export const metadata: Metadata = {
  ...
  description: 'Partner with Neusatz Aqua for innovative aquaculture research and collaboration alongside leading marine science alliances, Horizon Europe, and global institutions.',
  keywords: 'aquaculture partnerships, research collaboration, marine science alliance, Horizon Europe, innovation network, shrimp hatchery partnerships, scientific collaboration, Neusatz Aqua partners',
  openGraph: {
