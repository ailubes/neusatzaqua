...
export const metadata: Metadata = {
  ...
  keywords: 'AI aquaculture, computer vision shrimp, behavior detection, digital twin hatchery, predictive analytics, real-time monitoring, aquaculture innovation, shrimp AI, Vismar Aqua research, marine research alliance, global technology partners, Horizon Europe',
  openGraph: {
